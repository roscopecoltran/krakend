...
import (
	...
	"github.com/roscopecoltran/krakend/cmd/searx/convert/models"
)
...
type Provider struct {
	...
	AcceptHeader         []ProviderAcceptHeader      `gorm:"many2many:provider_accept_headers;" json:"accept_header,omitempty" yaml:"accept_header,omitempty" toml:"accept_header,omitempty"`
	...
	Categories           []models.ClassifyCategory   `gorm:"column:categories" json:"categories,omitempty" yaml:"categories,omitempty" toml:"categories,omitempty"`
	...
	CategoryToKeyword    []ProviderCategoryToKeyword `gorm:"many2many:provider_category_to_keywords;" json:"category_to_keyword,omitempty" yaml:"category_to_keyword,omitempty" toml:"category_to_keyword,omitempty"`
	...
	CountryToHostname    []ProviderCountryToHostname `gorm:"many2many:provider_country_to_hostnames;" json:"country_to_hostname,omitempty" yaml:"country_to_hostname,omitempty" toml:"country_to_hostname,omitempty"`
	...
	ImageSizes           []ProviderImageSize         `gorm:"many2many:provider_image_sizes;" json:"image_sizes,omitempty" yaml:"image_sizes,omitempty" toml:"image_sizes,omitempty"`
	...
	SafeSearchTypes      []ProviderSafeSearchType    `gorm:"many2many:provider_safe_search_types;" json:"safesearch_types,omitempty" yaml:"safesearch_types,omitempty" toml:"safesearch_types,omitempty"`
	...
	SearchCategory       []ProviderSearchCategory    `gorm:"many2many:provider_search_categories;" json:"search_category,omitempty" yaml:"search_category,omitempty" toml:"search_category,omitempty"`
	...
	ShorcutDict          []ProviderShortcut          `gorm:"many2many:provider_shortcuts;" json:"shorcut_dict,omitempty" yaml:"shorcut_dict,omitempty" toml:"shorcut_dict,omitempty"`
	...
	TimeRangeDict        []ProviderTimeRange         `gorm:"many2many:provider_time_ranges;" json:"time_range_dict,omitempty" yaml:"time_range_dict,omitempty" toml:"time_range_dict,omitempty"`
	...
	Extract ProviderNodes `gorm:"many2many:provider_nodes;" json:"extract,omitempty" yaml:"extract,omitempty" toml:"extract,omitempty"`
	URLS    []ProviderURL `gorm:"many2many:provider_urls;" json:"urls,omitempty" yaml:"urls,omitempty" toml:"urls,omitempty"`
}
...
type ProviderNodes struct {
	...
	Leafs []ProviderPath `gorm:"many2many:provider_path_leafs;" storm:"leafs" json:"leafs" yaml:"leafs" toml:"leafs"`
	Paths []ProviderPath `gorm:"many2many:provider_paths;"" storm:"paths" json:"paths" yaml:"paths" toml:"paths"`
}
...
type ProviderPathBlocks struct {
	gorm.Model `json:"-" yaml:"-" toml:"-"`
	...
	URL                 string                    `gorm:"column:url" json:"url,omitempty" yaml:"url,omitempty" toml:"url,omitempty"`
	Extra               []ProviderPathExtraBlocks `gorm:"many2many:provider_path_extras;" json:"extra,omitempty" yaml:"extra,omitempty" toml:"extra,omitempty"`
}

type ProviderQueryPattern struct {
	gorm.Model `json:"-" yaml:"-" toml:"-"`
...
type ProviderPathExtraBlocks struct {
	gorm.Model `json:"-" yaml:"-" toml:"-"`
...
type ProviderSafeSearchTypes struct {
	gorm.Model `json:"-" yaml:"-" toml:"-"`
	Disabled   bool                     `gorm:"column:disabled" default:"false" storm:"disabled" json:"disabled" yaml:"disabled" toml:"disabled"`
	Debug      bool                     `gorm:"column:column" default:"false" example:"false" storm:"debug" json:"debug" yaml:"debug" toml:"debug"`
	List       []ProviderSafeSearchType `gorm:"many2many:provider_safe_search_types;" json:"safesearch_types,omitempty" yaml:"safesearch_types,omitempty" toml:"safesearch_types,omitempty"`
}

type ProviderSafeSearchType struct {
	gorm.Model `json:"-" yaml:"-" toml:"-"`
	Disabled   bool   `gorm:"column:disabled" default:"false" storm:"disabled" json:"disabled" yaml:"disabled" toml:"disabled"`
	Debug      bool   `gorm:"column:column" default:"false" example:"false" storm:"debug" json:"debug" yaml:"debug" toml:"debug"`
...
type ProviderTimeRanges struct {
	gorm.Model `json:"-" yaml:"-" toml:"-"`
	Disabled   bool                `gorm:"column:disabled" default:"false" storm:"disabled" json:"disabled" yaml:"disabled" toml:"disabled"`
	Debug      bool                `gorm:"column:column" default:"false" example:"false" storm:"debug" json:"debug" yaml:"debug" toml:"debug"`
	List       []ProviderTimeRange `gorm:"many2many:provider_time_ranges;" json:"time_ranges,omitempty" yaml:"time_ranges,omitempty" toml:"time_ranges,omitempty"`
}

type ProviderTimeRange struct {
	gorm.Model `json:"-" yaml:"-" toml:"-"`
	Disabled   bool   `gorm:"column:disabled" default:"false" storm:"disabled" json:"disabled" yaml:"disabled" toml:"disabled"`
	Debug      bool   `gorm:"column:column" default:"false" example:"false" storm:"debug" json:"debug" yaml:"debug" toml:"debug"`
	Key        string `gorm:"column:key" json:"key" yaml:"key" toml:"key"`
...
type ProviderImageSizes struct {
	gorm.Model `json:"-" yaml:"-" toml:"-"`
	Disabled   bool                `gorm:"column:disabled" default:"false" storm:"disabled" json:"disabled" yaml:"disabled" toml:"disabled"`
	Debug      bool                `gorm:"column:column" default:"false" example:"false" storm:"debug" json:"debug" yaml:"debug" toml:"debug"`
	List       []ProviderImageSize `gorm:"many2many:provider_image_sizes;" json:"image_sizes,omitempty" yaml:"image_sizes,omitempty" toml:"image_sizes,omitempty"`
}

type ProviderImageSize struct {
	gorm.Model `json:"-" yaml:"-" toml:"-"`
	Disabled   bool   `gorm:"column:disabled" default:"false" storm:"disabled" json:"disabled" yaml:"disabled" toml:"disabled"`
	Debug      bool   `gorm:"column:column" default:"false" example:"false" storm:"debug" json:"debug" yaml:"debug" toml:"debug"`
...
type ProviderAcceptHeaders struct {
	gorm.Model `json:"-" yaml:"-" toml:"-"`
	Disabled   bool                   `gorm:"column:disabled" default:"false" storm:"disabled" json:"disabled" yaml:"disabled" toml:"disabled"`
	Debug      bool                   `gorm:"column:column" default:"false" example:"false" storm:"debug" json:"debug" yaml:"debug" toml:"debug"`
	List       []ProviderAcceptHeader `gorm:"many2many:provider_accept_headers;" json:"accept_headers,omitempty" yaml:"accept_headers,omitempty" toml:"accept_headers,omitempty"`
}

type ProviderAcceptHeader struct {
	gorm.Model `json:"-" yaml:"-" toml:"-"`
	Disabled   bool   `gorm:"column:disabled" default:"false" storm:"disabled" json:"disabled" yaml:"disabled" toml:"disabled"`
	Debug      bool   `gorm:"column:column" default:"false" example:"false" storm:"debug" json:"debug" yaml:"debug" toml:"debug"`
	Value      string `gorm:"column:value" json:"value" yaml:"value" toml:"value"`
...
type ProviderCountryToHostnames struct {
	gorm.Model `json:"-" yaml:"-" toml:"-"`
	Disabled   bool                        `gorm:"column:disabled" default:"false" storm:"disabled" json:"disabled" yaml:"disabled" toml:"disabled"`
	Debug      bool                        `gorm:"column:column" default:"false" example:"false" storm:"debug" json:"debug" yaml:"debug" toml:"debug"`
	List       []ProviderCountryToHostname `gorm:"many2many:provider_country_to_hostnames;" json:"country_to_hostnames,omitempty" yaml:"country_to_hostnames,omitempty" toml:"country_to_hostnames,omitempty"`
}

type ProviderCountryToHostname struct {
	gorm.Model  `json:"-" yaml:"-" toml:"-"`
	Disabled    bool   `gorm:"column:disabled" default:"false" storm:"disabled" json:"disabled" yaml:"disabled" toml:"disabled"`
	Debug       bool   `gorm:"column:column" default:"false" example:"false" storm:"debug" json:"debug" yaml:"debug" toml:"debug"`
...
type ProviderSearchCategories struct {
	gorm.Model `json:"-" yaml:"-" toml:"-"`
	Disabled   bool                     `gorm:"column:disabled" default:"false" storm:"disabled" json:"disabled" yaml:"disabled" toml:"disabled"`
	Debug      bool                     `gorm:"column:column" default:"false" example:"false" storm:"debug" json:"debug" yaml:"debug" toml:"debug"`
	List       []ProviderSearchCategory `gorm:"many2many:provider_search_categories;" json:"category_to_keywords,omitempty" yaml:"category_to_keywords,omitempty" toml:"category_to_keywords,omitempty"`
}

type ProviderSearchCategory struct {
	gorm.Model   `json:"-" yaml:"-" toml:"-"`
	Disabled     bool   `gorm:"column:disabled" default:"false" storm:"disabled" json:"disabled" yaml:"disabled" toml:"disabled"`
	Debug        bool   `gorm:"column:column" default:"false" example:"false" storm:"debug" json:"debug" yaml:"debug" toml:"debug"`
...
type ProviderCategoryToKeywords struct {
	gorm.Model `json:"-" yaml:"-" toml:"-"`
	Disabled   bool                        `gorm:"column:disabled" default:"false" storm:"disabled" json:"disabled" yaml:"disabled" toml:"disabled"`
	Debug      bool                        `gorm:"column:column" default:"false" example:"false" storm:"debug" json:"debug" yaml:"debug" toml:"debug"`
	List       []ProviderCategoryToKeyword `gorm:"many2many:provider_category_to_keywords;" json:"category_to_keywords,omitempty" yaml:"category_to_keywords,omitempty" toml:"category_to_keywords,omitempty"`
}

type ProviderCategoryToKeyword struct {
	gorm.Model   `json:"-" yaml:"-" toml:"-"`
	Disabled     bool   `gorm:"column:disabled" default:"false" storm:"disabled" json:"disabled" yaml:"disabled" toml:"disabled"`
	Debug        bool   `gorm:"column:column" default:"false" example:"false" storm:"debug" json:"debug" yaml:"debug" toml:"debug"`
	CategoryName string `gorm:"column:category_name" json:"category_name" yaml:"category_name" toml:"category_name"`
...
type ProviderShortcuts struct {
	gorm.Model `json:"-" yaml:"-" toml:"-"`
	Disabled   bool               `gorm:"column:disabled" default:"false" storm:"disabled" json:"disabled" yaml:"disabled" toml:"disabled"`
	Debug      bool               `gorm:"column:column" default:"false" example:"false" storm:"debug" json:"debug" yaml:"debug" toml:"debug"`
	Shortcuts  []ProviderShortcut `gorm:"many2many:provider_shortcuts;" json:"shortucts,omitempty" yaml:"shortucts,omitempty" toml:"shortucts,omitempty"`
}
