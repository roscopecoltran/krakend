...
type Backend struct {
	...
	// URL pattern to use to locate the resource to be consumed
	QueryStrings map[string]string `gorm:"column:query_strings" mapstructure:"query_strings" json:"query_strings" yaml:"query_strings"`
	// URL pattern to use to locate the resource to be consumed
	Parameters map[string]string `gorm:"column:parameters" mapstructure:"parameters" json:"parameters" yaml:"parameters"`
	...
	URLKeys []string `gorm:"-" mapstructure:"url_keys" json:"url_keys" yaml:"url_keys"`
	...
	Decoder encoding.Decoder `gorm:"-" mapstructure:"decoder" json:"-" yaml:"-"`
	// Backend Extra configuration for customized behaviours
	ExtraConfig ExtraConfig `gorm:"-" mapstructure:"extra_config" json:"-" yaml:"-"` // many2many:backends_extra_config;
}
