...
type HtmlSelectorConfig struct {
	...
	Xpath      string `gorm:"column:xpath" json:"xpath,omitempty" yaml:"xpath,omitempty" toml:"xpath,omitempty"`
	Attr       string `gorm:"column:attr" json:"attr" yaml:"attr" toml:"attr"`
	Regex      string `gorm:"column:regex" json:"regex" yaml:"regex" toml:"regex"`
	Replace    string `gorm:"column:replace" json:"replace" yaml:"replace" toml:"replace"`
	Default    string `gorm:"column:default" json:"default" yaml:"default" toml:"default"`
	Prefix     string `gorm:"column:prefix" json:"prefix" yaml:"prefix" toml:"prefix"`
	Suffix     string `gorm:"column:suffix" json:"suffix" yaml:"suffix" toml:"suffix"`
	Array      string `gorm:"column:array" json:"array" yaml:"array" toml:"array"`
