...
type EndpointConfig struct {
	...
	Header []string `gorm:"-" mapstructure:"headers" json:"header" yaml:"header"` // many2many:endpoints_config;
	// HTTP headers of the endpoint to forward
	...
	QueryString []string `gorm:"-" mapstructure:"querystring_params" json:"querystring_params"  yaml:"querystring_params"` // many2many:endpoints_query_string;
	// list of query string params to be extracted from the URI
	QueryStrings string `gorm:"column:query_strings" mapstructure:"query_strings" json:"query_strings"  yaml:"query_strings"`
