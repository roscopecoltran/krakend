...
func filterTarget(filterString string, entity *Response) {
	var rawData interface{}
	rawData = entity.Data
	if err := filter.Filter(&rawData, filterString); err != nil {
		fmt.Println(" \n error while filtering entity.Data: ", err)
	}
	entity.Data, _ = rawData.(map[string]interface{})
}
...
/*
	Refs:
	- https://github.com/ivenabc/json_filter
 	- https://github.com/ti/filter
*/
